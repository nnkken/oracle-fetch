...
func (_m *MockDataSource) Fetch() ([]DBEntry, error) {
	ret := _m.Called()

	var r0 []DBEntry
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]DBEntry, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []DBEntry); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]DBEntry)
		}
	}
...
func (_c *MockDataSource_Fetch_Call) Return(_a0 []DBEntry, _a1 error) *MockDataSource_Fetch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataSource_Fetch_Call) RunAndReturn(run func() ([]DBEntry, error)) *MockDataSource_Fetch_Call {
	_c.Call.Return(run)
	return _c
}
